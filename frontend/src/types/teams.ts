...
import { FaseEtapa } from "./chave";

// Re-export from etapa.ts
export {
  VarianteTeams,
  TipoFormacaoEquipe,
  TipoFormacaoJogos,
 ...
 */
export enum StatusPartidaTeams {
  AGENDADA = "agendada",
  EM_ANDAMENTO = "em_andamento",
...
/**
 * DTO para gerar equipes automaticamente
 */
export interface GerarEquipesDTO {
  tipoFormacaoJogos?: string; // "sorteio" | "manual"
}

/**
 * DTO para formação manual de equipe
 */
...
/**
 * DTO para formar equipes manualmente
 */
export interface FormarEquipesManualDTO {
  formacoes: FormacaoManualEquipeDTO[];
  tipoFormacaoJogos?: string;
}

/**
 * DTO para definir partida manual
 */
export interface DefinirPartidaManualDTO {
  ordem: number;
...
export interface DefinirPartidasManualDTO {
  partidas: DefinirPartidaManualDTO[];
}
...
/**
 * Resposta da geração de equipes
 */
export interface GerarEquipesResponse {
  message: string;
  equipes: number;
  confrontos: number;
}
...
/**
 * Resposta da geração de partidas
 */
export interface GerarPartidasResponse {
  message: string;
  partidas: number;
}

/**
 * Resposta da geração de decider
 */
export interface GerarDeciderResponse {
  message: string;
  decider: PartidaTeams;
}
