...
export class EtapaRepository implements IEtapaRepository {
  ...
  async criar(
    ...
    const etapaData: any = {
      ...
      tipoFormacaoDupla: data.tipoFormacaoDupla, // Para DUPLA_FIXA balanceada
  ...
  async decrementarInscritosEmLote(
    ...
    logger.info("Inscritos decrementados em lote", {
      etapaId: id,
      quantidade,
      novoTotal: jogadoresInscritos.length,
    });
  }
