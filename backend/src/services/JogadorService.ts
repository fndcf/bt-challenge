  ...
  async criar(
    ...
    try {
      ...
      const jogadorData = {
        ...
        email: dadosValidados.email?.trim().toLowerCase() || null,
        telefone: dadosValidados.telefone?.trim() || null,
        dataNascimento: dadosValidados.dataNascimento || null,
        genero: dadosValidados.genero || null,
        nivel: dadosValidados.nivel,
        status: dadosValidados.status || StatusJogador.ATIVO,
        observacoes: dadosValidados.observacoes?.trim() || null,
        fotoUrl: null,
        vitorias: 0,
        derrotas: 0,
        pontos: 0,
